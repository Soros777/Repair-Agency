...
CREATE TABLE IF NOT EXISTS `repairagency`.`clients` (
  ...
  `photo` VARCHAR(50) NOT NULL DEFAULT 'img/clients/userIcon.png',
...
CREATE TABLE IF NOT EXISTS `repairagency`.`managers` (
  ...
  `photo` VARCHAR(50) NOT NULL DEFAULT 'img/managers/managerIcon.png',
...
CREATE TABLE IF NOT EXISTS `repairagency`.`masters` (
  ...
  `password` VARCHAR(45) NOT NULL,
  `person_name` VARCHAR(100) NOT NULL,
  `photo` VARCHAR(50) NOT NULL DEFAULT 'img/masters/masterIcon.png',
  `contact_phone` VARCHAR(45) NOT NULL,
  `locale` ENUM('en', 'ua', 'us', 'ru') NOT NULL,
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `repairagency`.`administration` (
  ...
  `password` VARCHAR(45) NOT NULL,
  `person_name` VARCHAR(100) NOT NULL,
  `photo` VARCHAR(50) NOT NULL DEFAULT 'img/admin/adminIcon.png',
